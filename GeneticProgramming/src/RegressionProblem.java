...
public class RegressionProblem
  ...
  public static void readTable(String tableFileName) throws FileNotFoundException{
	  ...
	  sc.close();
	  RegressionProblem.x = xFromFile.to
  }
  ...
  public static void main(String[] args)
    ...
    config.setFitnessFunction(new RegressionProblem.FormulaFitnessFunction());
    config.setStrictProgramCreation(true);
    GPProblem problem = new RegressionProblem(config);
    // Create the truth table for the Formula Fitness function to use
    RegressionProblem.readTable(args[0]);
    ...
    // a PNG file.
    // ----------------------------------------------------------------------
    problem.showTree(gp.getAllTimeBest(), "regressionproblem_best.png");
  }
